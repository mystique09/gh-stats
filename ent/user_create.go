...
func (uc *UserCreate) SetVisits(u uint64) *UserCreate {
	uc.mutation.SetVisits(u)
	return uc
}

// SetNillableVisits sets the "visits" field if the given value is not nil.
func (uc *UserCreate) SetNillableVisits(u *uint64) *UserCreate {
	if u != nil {
		uc.SetVisits(*u)
	}
	return uc
...
func (uc *UserCreate) defaults() {
	if _, ok := uc.mutation.Visits(); !ok {
		v := user.DefaultVisits
		uc.mutation.SetVisits(v)
	}
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.Visits(); !ok {
		return &ValidationError{Name: "visits", err: errors.New(`ent: missing required field "User.visits"`)}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.Visits(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
